...
class ProductoTiendaService:
    ...
    async def crear_producto(
        self, schema: ProductoTiendaInicial
    ) -> ProductoTiendaModel:
    ...
    async def actualizar_producto(
        ...
        producto = await self.repo.get_by_id_or_fail(
            producto_id, id_column="producto_id", entity_name="Producto"
        )
